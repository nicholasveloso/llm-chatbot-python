# Importando as bibliotecas para o gerar a cadeia e template de prompt.
...
```
If asked about how many degrees of separation there are between two people, compose an answer with the pathBetweenPeople.
